#! /bin/bash                                                                                                        
# Batch submission job script, executes run_EIC_batch_5on100.csh script
...
while [[ $i -le $NumFiles ]]; do
    ...
    echo "./run_EIC_batch_5on100.csh ${i} ${NumEvents} ${RandomSeed} ${OutputType}" >> ${batch} # Run your script, change this to what you like
    echo "date">>${batch}
